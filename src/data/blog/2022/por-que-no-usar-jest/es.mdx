...
Hace un par de meses probé [Node Tap](https://node-tap.org), que es el *test framework* que recomienda [Matteo Collina](https://twitter.com/matteocollina) como alternativa a Jest para testear tu código. Aunque me pareció una gran herramienta, no me terminó de convencer la forma de organizar los test y como hasta ahora no me he encontrado ningún problema con Jest, pues no me peleé mucho con él. Sin embargo, sigo viendo tweets en los que no recomiendan su uso y hasta ahora no me había puesto a indagar en el por qué.

En un tweet que ya no está disponible Matteo Collina se quejaba sobre el hecho de que le llegan issues en Github a los paquetes que mantiene ([casi 500 en npm](https://www.npmjs.com/~matteo.collina)) en los que el problema es Jest y como este altera el entorno de ejecución. En segundo lugar, [James Snell](https://twitter.com/jasnell), pese a que no suele menospreciar los proyectos Open Source, respondía a Matteo confirmando que no recomendaría usar Jest.
...
<XEmbed
  url="https://x.com/matteocollina/status/1479955450179301382"
