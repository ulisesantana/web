...
featured: true
lang: en
slug: how-i-took-a-nodejs-process-from-5-hours-to-5-minutes
---
...
<YouTubeVideo
  videoId="V4sXNlzJIy8"
  caption="This post was originally a talk I gave at JSDay Canarias 2022"
/>
...
<Img src={import("./lumberjack.jpeg")} alt="Me dressed as a Lumberjack with an ax on my shoulder" />
...
<Img src={import("./coffin-dance.gif")} alt="GIF of the coffin dancers" />
...
<Img src={import("./sheldon-bag.gif")} alt="GIF of Sheldon breathing compulsively into a paper bag" />

<Img src={import("./pickle-rick.gif")} alt="GIF of Pickle Rick about to die of heat stroke" />
...
<Img src={import("./useless-async.png")} alt="Result of running the demo for async comparison" />
...
<Img src={import("./await-loop.jpeg")} alt="Promises are resolved one by one" caption="Resolving promises with an await inside a for" />
...
<Img src={import("./promise-all.jpeg")} alt="Promises are resolved at the same time" caption="Resolving promises with a Promise.all" />
...
<Img src={import("./async-loop.png")} alt="Result of running the demo for asynchronous loops" />
...
<Img src={import("./cjs-to-esm.png")} alt="Go from CommonJS to ESModules" />
...
<Img src={import("./fuck-yeah-dude.gif")} alt="GIF of The Dude in the Big Lebowski celebrating in his car" />
