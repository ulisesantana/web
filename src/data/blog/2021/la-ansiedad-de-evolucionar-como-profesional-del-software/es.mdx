...
<Img src={import("./chromebook-nodeconfeu2018.jpg")} alt="Mi chromebook tratando de compilar Node.js durante la NodeCONF EU 2018" caption="En mi primera NodeCONF EU fui a un taller para hacer mi primera aportación a Node.js. El problema es que fui con un chromebook que tardó casi 2 horas en compilar Node.js." />
