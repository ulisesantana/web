...
<Img src={import("./oclif-single-cli.png")} alt="Captura de pantalla de cómo genera oclif un cli de un sólo comando" caption="oclif nos pregunta todo lo que necesita para crear nuestro CLI desde cero." />
...
<Img src={import("./cli-ux-spinner.gif")} alt="Ejemplo de como se ve el spinner de cli-ux" caption="Un spinner en tu terminal gracias a cli-ux. (Imagen sacada de la documentación de cli-ux)" />
