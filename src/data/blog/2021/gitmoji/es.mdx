...
<Img src={import("./gitmoji.png")} alt="Captura de pantalla del buscador de la web de gitmoj" caption="En la web de gitmoji podemos buscar que emoji necesitamos en base a la intención de nuestro commit." />
...
<Img src={import("./gitmoji-cli.gif")} alt="Ejemplo de uso de gitmoji-cli" caption="gitmoji-cli nos permite usar gitmoji sin salir de la terminal." />
...
<Img src={import("./gitlog.png")} alt="Log de git con commits precedidos de un emoji" caption="El log de git puede ser muy visual y autoexplicativo gracias a gitmoji." />
