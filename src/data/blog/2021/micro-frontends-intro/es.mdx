...
<Img src={import("./monolith-frontback-microservices.png")} alt="Comparación entre arquitecturas" caption="Imagen de micro-frontends.org" />
...
<Img src={import("./verticals-headline.png")} alt="Comparación entre arquitecturas" caption="Imagen de micro-frontends.org" />
...
<Img src={import("./micro-frontend-split.jpeg")} alt="Gráfico que muestra la división de micro frontends vertical u horizontalmente" caption="Imagen de un post de Increment sobre micro frontends" />
