...
<Img src={import("./wifi-connect-instructions.png")} alt="Instrucciones de WiFi Connect (en inglés)" />
...
<Img src={import("./balena-etcher.png")} alt="Balena Etcher" caption="Balena Etcher es un software maravilloso para flashear imágenes en dispositivos." />
...
<Img src={import("./wifi-connect-step-3-1.png")} alt="Selecciona la opción Localisation options" />

Ahora seleccionamos la opción `WLAN Country`.

<Img src={import("./wifi-connect-step-3-2.png")} alt="Selecciona la opción WLAN Country" />

Seleccionamos el país donde vayamos a usar la Raspberry, en mi caso es España.

<Img src={import("./wifi-connect-step-3-3.png")} alt="Selecciona la opción de tu país" />

Si todo ha salido bien debería de aparecer una pantalla como la siguiente, en la que lo único que tendremos que hacer es
darle a *ENTER*.

<Img src={import("./wifi-connect-step-3-4.png")} alt="Acepta los cambios" />
...
<Img src={import("./check-path.png")} alt="Cómo comprobar si hace falta actualizar el PATH" />
...
<Img src={import("./wifi-connect-status.png")} alt="Cómo comprobar que el estado del servicio de WiFi Connect funcionando correctamente" />
