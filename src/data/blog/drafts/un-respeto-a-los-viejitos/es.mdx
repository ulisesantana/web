...
<Img src={import("./stains-vietnam.gif")} alt="GIF de un perro con estrés post-traumático de Vietnam" />
...
<Img src={import("./mountain-strata.jpeg")} alt="Una montaña con diferentes estratos" caption="La formación Yesera en Argentina" />
...
<Img src={import("./callback-hadoken.gif")} alt="GIF de Ryu provocando los callback hell con un hadoken" />
